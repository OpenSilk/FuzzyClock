...
public class FuzzySettingsPrefsPage extends Fragment implements
    ...
    protected void chooseColor() {
        final ColorPrefAdapter.ColorChoice[] colorChoices = new ColorPrefAdapter.ColorChoice[] {
                new ColorPrefAdapter.ColorChoice(getString(R.string.mtrl_red),
                        getResources().getColor(R.color.red_500)),
                new ColorPrefAdapter.ColorChoice(getString(R.string.mtrl_pink),
                        getResources().getColor(R.color.pink_500)),
                new ColorPrefAdapter.ColorChoice(getString(R.string.mtrl_purple),
                        getResources().getColor(R.color.purple_500)),
                new ColorPrefAdapter.ColorChoice(getString(R.string.mtrl_dark_purple),
                        getResources().getColor(R.color.dark_purple_500)),
                new ColorPrefAdapter.ColorChoice(getString(R.string.mtrl_indigo),
                        getResources().getColor(R.color.indigo_500)),
                new ColorPrefAdapter.ColorChoice(getString(R.string.mtrl_blue),
                        getResources().getColor(R.color.blue_500)),
                new ColorPrefAdapter.ColorChoice(getString(R.string.mtrl_light_blue),
                        getResources().getColor(R.color.light_blue_500)),
                new ColorPrefAdapter.ColorChoice(getString(R.string.mtrl_cyan),
                        getResources().getColor(R.color.cyan_500)),
                new ColorPrefAdapter.ColorChoice(getString(R.string.mtrl_teal),
                        getResources().getColor(R.color.teal_500)),
                new ColorPrefAdapter.ColorChoice(getString(R.string.mtrl_green),
                        getResources().getColor(R.color.green_500)),
                new ColorPrefAdapter.ColorChoice(getString(R.string.mtrl_light_green),
                        getResources().getColor(R.color.light_green_500)),
                new ColorPrefAdapter.ColorChoice(getString(R.string.mtrl_lime),
                        getResources().getColor(R.color.lime_500)),
                new ColorPrefAdapter.ColorChoice(getString(R.string.mtrl_yellow),
                        getResources().getColor(R.color.yellow_500)),
                new ColorPrefAdapter.ColorChoice(getString(R.string.mtrl_amber),
                        getResources().getColor(R.color.amber_500)),
                new ColorPrefAdapter.ColorChoice(getString(R.string.mtrl_orange),
                        getResources().getColor(R.color.orange_500)),
                new ColorPrefAdapter.ColorChoice(getString(R.string.mtrl_deep_orange),
                        getResources().getColor(R.color.deep_orange_500)),
                new ColorPrefAdapter.ColorChoice(getString(R.string.mtrl_brown),
                        getResources().getColor(R.color.brown_500)),
                new ColorPrefAdapter.ColorChoice(getString(R.string.mtrl_grey),
                        getResources().getColor(R.color.grey_500)),
                new ColorPrefAdapter.ColorChoice(getString(R.string.mtrl_blue_grey),
